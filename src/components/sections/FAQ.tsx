...
const faqs = [
  {
    ...
    answer:
      "Заполните форму регистрации на сайте, указав данные команды и капитана. После этого оплатите взнос за участие банковской картой через защищённый платёжный сервис.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "После заполнения формы вы будете перенаправлены на страницу безопасной оплаты банковской картой. После успешной оплаты статус заявки автоматически меняется на 'Оплачено', а администратор получает уведомление. Чек об оплате приходит на email, указанный при регистрации.",
  },
  {
    question: "Можно ли вернуть деньги за участие?",
    answer:
      "Вступительный взнос не возвращается, за исключением отмены турнира организатором — в этом случае средства возвращаются в полном объёме в течение 14 рабочих дней. Подробности — в Публичной оферте.",
  },
  {
